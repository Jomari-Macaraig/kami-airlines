...
class AirplaneModelTests(TestCase):
    ...
    def test_fuel_tank_capacity(self) -> None:
        expected_result = self.airplane.MINIMUM_FUEL * self.airplane.id
    ...
    def test_total_fuel_consumption_per_minute(self) -> None:
        ...
        expected_result = airplane_fuel_consumption_per_minute + additional_fuel_consumption_from_passenger_per_minute
